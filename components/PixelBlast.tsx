...
void main(){
  ...
  float speed2=uRippleSpeed; float thickness=uRippleThickness;
...
const PixelBlast = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      if (noiseAmount > 0) {
        if (!composer) { composer = new EffectComposer(renderer as any); composer.addPass(new RenderPass(scene, camera)); }
